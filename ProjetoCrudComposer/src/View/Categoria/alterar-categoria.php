    ...
    <div class="card mt-5 mb-5 border border-info-subtle" style="margin-left: 8%; margin-right: 8%;">
        ...
        <form action="/categoria/alterar/novo" class="card-body shadow p-3" method="post">
            <div class="mb-3">
                ...
                <label for="nome" class="form-label">Informe o novo nome da categoria:</label>
                <input type="text" class="form-control" id="nome" name="nome" aria-describedby="nome" value="<?= $categoria['nome']; ?>">
            </div>
            <div class="mb-3">
