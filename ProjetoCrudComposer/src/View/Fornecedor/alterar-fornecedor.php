        ...
        <form action="/fornecedor/alterar/novo" class="card-body shadow p-3" method="post">
            <div class="mb-3">
                ...
                <div class="col-5 ">
                    ...
                    <input type="text" class="form-control" id="nome" name="nome" aria-describedby="nome" value="<?= $fornecedor['nome']; ?>">
                    <label for="cnpj" class="form-label mt-3">CNPJ:</label>
                    <input type="text" class="form-control bg-secondary-subtle" id="cnpj" name="cnpj" aria-describedby="cnpj" value="<?= $fornecedor['cnpj']; ?>" readonly>
                </div>
                <div class="col-5">
                    <label for="endereco" class="form-label mt-3">Endereço:</label>
                    <input type="text" class="form-control" id="endereco" name="endereco" aria-describedby="endereco" value="<?= $fornecedor['endereco']; ?>">
                    <label for="telefone" class="form-label mt-3">Telefone:</label>
                    <input type="tel" class="form-control" id="telefone" name="telefone" aria-describedby="telefone" value="<?= $fornecedor['telefone']; ?>">
                </div>
            </div>
            <div class="mb-3">
                <button type="submit" class="btn bg-info-subtle mt-5">Alterar</button>
            </div>
        </form>
    </div>
