        ...
        <form action="/produto/alterar/novo" class="card-body shadow p-3" method="post">
            <div class="mb-3">
                ...
                <div class="col-5 ">
                    ...
                    <input type="number" class="form-control" id="quantidade" name="quantidade" aria-describedby="quantidade" value="<?= $produto['quantidade']; ?>">
                </div>
                <div class="col-5">
                    <label for="valor" class="form-label mt-3">Valor:</label>
                    <input type="text" class="form-control" id="valor" name="valor" aria-describedby="valor" value="<?= $produto['valor']; ?>">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <select name="fornecedor_id" id="fornecedor_id" class="form-control" aria-describedby="fornecedor_id">
