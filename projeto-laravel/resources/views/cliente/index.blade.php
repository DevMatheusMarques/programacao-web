...
<main class="container mx-auto p-8">
    <a href="{{ route('cliente.create') }}" class="mb-5 inline-block">
        <button type="button" class="bg-blue-200 text-blue-800 py-2 px-4 rounded shadow hover:bg-gray-200">Cadastrar Novo Cliente</button>
    </a>

    <div class="bg-white shadow rounded-lg p-6">
        <div class="mb-4 pb-4 border-b border-blue-200">
            <strong class="text-lg text-blue-800">Clientes Cadastrados</strong>
        </div>
        <div class="overflow-x-auto">
            <table class="min-w-full bg-white mt-5" id="table">
                ...
                <tr>
                    ...
                    <th class="py-2 px-4 bg-blue-100 border-b border-blue-200 text-center">CPF</th>
                    <th class="py-2 px-4 bg-blue-100 border-b border-blue-200 text-center">E-mail</th>
                ...
                @foreach ($clientes as $cliente)
                    <tr class="border-b border-blue-200 hover:bg-gray-50 text-center">
                        ...
                        <td class="py-2 px-4">
                            <a href="{{ route('cliente.show', $cliente->id) }}"><i class="fa-solid fa-magnifying-glass"></i></a>
                            <a href="{{ route('cliente.edit', $cliente->id) }}" class="text-blue-500 hover:text-blue-700">
                                <i class="fa-solid fa-pencil"></i>
                            </a>
                            <form action="{{ route('cliente.destroy', $cliente->id) }}" method="post" class="inline">
                                @csrf
                                @method('DELETE')
                                <button type="button" class="btn-delete" data-id="{{ $cliente->id }}">
