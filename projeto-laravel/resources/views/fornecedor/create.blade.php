...
<main class="container mx-auto p-8">
    <div class="bg-white border border-gray-200 rounded-lg shadow-md p-6 mb-8">
        ...
        <form action="{{route("fornecedor.store")}}" method="post" class="space-y-4">
            ...
            <div class="space-y-4">
                <div>
                    <label for="nome" class="block text-sm font-medium text-gray-700">Informe o nome do fornecedor:</label>
                ...
                <div>
                    <label for="cnpj" class="block text-sm font-medium text-gray-700 mt-3">Informe o CNPJ do fornecedor:</label>
                    <input type="text" class="block w-full mt-1 border-gray-300  rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" id="cnpj" name="cnpj" maxlength="14" required>
                </div>
                <div>
